...
- [ ] 2. Publish the approved plan into tracked history before behavior changes
...
- [ ] 3. Capture failing-first contract checks for OmO-harness-first Study Forge
...
- [ ] 4. Rewrite top-level Study Forge routing around the OmO harness and finals happy path
...
- [ ] 5. Rewrite the shared delegation reference as a portable OmO/Codex worker contract
...
- [ ] 6. Tighten index and artifact references for source-pack-first, proof-ledger-backed study workflows
...
- [ ] 7. Update delegation validators and fixtures to enforce the new OmO-harness contract
...
- [ ] 8. Remove stale bespoke-orchestration claims and preserve role docs as prompt templates
...
- [ ] 9. Sync installed global Study Forge skill after repo checks pass
...
- [ ] 10. Run full validation, commit audit, and branch status report
